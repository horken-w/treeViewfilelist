...
(function ($) {
    $.fn.EasyTree = function (options) {
        var defaults = {
            ...
            i18n: {
                deleteNull: '選擇要刪除的檔案',
                deleteConfirmation: '確定要刪除這個檔案嗎?',
                confirmButtonLabel: '沒問題',
                editNull: '選擇欲修改的檔案',
                editMultiple: '一次只能修改一個檔案',
                addMultiple: '選擇需要新增的檔案位置',
                collapseTip: '收合',
                expandTip: '展開',
                selectTip: '選取',
                unselectTip: '取消選取',
        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(children).remove();
                    text = $(this).text();
                    $(this).html('<span><span class="glyphicon"></span><a href="'+ $(this).find('a').attr('href') +'"></a> </span>');
            ...
            $(easyTree).find('li').addClass('parent_li').find(' > span').attr('title', options.i18n.collapseTip);
